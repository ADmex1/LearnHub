        ...
        <section
            ...
            <div class="max-w-3xl">
                ...
                <div class="mt-8 flex flex-wrap gap-4">
                    <span class="bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium">Web
                        Development</span>
                    <span
                        class="bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium">Cybersecurity</span>
                </div>
