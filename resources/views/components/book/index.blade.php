        ...
        <div class="bg-white dark:bg-gray-800 relative border-md sm:rounded-lg ">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <a href="/my-book/create" data-modal-target="createProductModal1a"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-4">Index</th>
                            <th scope="col" class="px-4 py-3">Title</th>
                            <th scope="col" class="px-4 py-3">Category</th>
                            <th scope="col" class="px-4 py-3">Publish Date</th>
                    ...
                    <tbody>
                        @foreach ($books as $book)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 max-w-[12rem] truncate">{{ $book->category->name }}</td>
                                <td class="px-4 py-3">{{ $book->created_at->diffForHumans() }}</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div id="book-{{ $book->id }}-dropdown"
                                        ...
                                        <ul class="py-1 text-sm"
                                            aria-labelledby="book-{{ $book->id }}-dropdown-button">
                                            <li>
                                            ...
                                            <li>
                                                <button type="button"
                                                    data-modal-target="deleteModal-{{ $book->id }}"
                                                    data-modal-toggle="deleteModal-{{ $book->id }}"
                                    ...
                                    <div id="deleteModal-{{ $book->id }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            ...
                                            <div
                                                ...
                                                <div class="flex justify-center items-center space-x-4">
                                                    <button data-modal-toggle="deleteModal-{{ $book->id }}"
                                                        type="button"
                                                        class="py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No,
                                                        cancel</button>
                                                    <form action="/my-book/{{ $book->slug }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
